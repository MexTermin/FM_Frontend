                            ...
                            <div class="lg:w-11/12 px-4 md:px-0">
                                <div class="md:p-5 md:mx-6">
                                    <div class="text-center">
                                        ...
                                        <h4 class="text-xl font-semibold mt-1 mb-12 pb-1">Crear categoría</h4>
                                    </div>
                                    <form>
                                        <div class="mb-4">
                                        ...
                                        <div class="text-center pt-1 mb-12 pb-1">
                                            <button v-on:click="CreateCategory" id="btn-guardar"
...
async function CreateCategory() {
    const url: string | undefined = `${VITE_FM_API_URL}/category`;
    const body = {
    ...
    if (data.ok) {
        ...
        else msg.value = "No se ha podido crear la categoria";
        showAlert.value = true;
    }

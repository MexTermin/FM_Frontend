                            ...
                            <div class="lg:w-5/6 px-4 md:px-0">
                                <div class="md:p-4 md:mx-6">
                                    <div class="text-center">
                                        ...
                                        <h4 class="text-xl font-semibold mt-1 mb-6 pb-1">Editar categoría</h4>
                                    </div>
                                    <form>
                                        ...
                                        <div class="text-center pt-1 mb-12 pb-1">
                                            <button v-on:click="ActualizarCategoria"
...
async function ActualizarCategoria() {
    ...
    if (data.ok) {
        ...
        window.location.href = `/details-category/?id=${id.value}`;

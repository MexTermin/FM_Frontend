<template>
    <div class="fixed top-0 left-0 justify-center w-screen">
        <div id="alert-4" class="ml-auto mr-auto flex w-2/5 p-4 mb-4 mt-3 bg-yellow-100 rounded-lg dark:bg-yellow-200"
            role="alert">
            <svg class="flex-shrink-0 w-5 h-5 text-yellow-700 dark:text-yellow-800" fill="currentColor"
